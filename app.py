...
def main():
    ...
    try:
        ...
        logger.info("=" * 70)
        logger.info(f"🌐 Platform: http://{Config.FLASK_HOST}:{Config.FLASK_PORT}")
        logger.info(f"📋 Demo Guide: http://{Config.FLASK_HOST}:{Config.FLASK_PORT}/demo")
        logger.info(f"🔧 Debug: http://{Config.FLASK_HOST}:{Config.FLASK_PORT}/api/debug/inventory")
        logger.info("=" * 70)
